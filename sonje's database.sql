...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 03, 2024 at 12:07 PM
...
ALTER TABLE `languages`
  ...
  ADD KEY `languages_ibfk_2` (`deletedby`);
...
--
ALTER TABLE `moviesgenre`
  ADD CONSTRAINT `moviesgenre_ibfk_1` FOREIGN KEY (`addedby`) REFERENCES `users` (`userid`),
  ADD CONSTRAINT `moviesgenre_ibfk_2` FOREIGN KEY (`deletedby`) REFERENCES `users` (`userid`),
  ADD CONSTRAINT `moviesgenre_ibfk_3` FOREIGN KEY (`movieid`) REFERENCES `movies` (`movieid`),
  ADD CONSTRAINT `moviesgenre_ibfk_4` FOREIGN KEY (`genreid`) REFERENCES `genres` (`genreid`);
